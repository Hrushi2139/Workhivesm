...
// if you delete all channels if u redirect to workspaceId then it asks to create a channel if there is any channel then when we open it first redirects to channel